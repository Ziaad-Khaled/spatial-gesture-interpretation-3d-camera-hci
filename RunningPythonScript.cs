    ...
    class RunningPythonScript
    {
        ...
        */
        static void Option1_ExecProcess()
        {
            ...
            psi.FileName = @"C:\Users\Ziad\AppData\Local\Programs\Python\Python39\python.exe";

            // 2) Provide script and arguments
            var script = @"D:\GUC\Bachelor\RunPythonScriptFromCS\DaysBetweenDates.py";
            var start = "2019-1-1";
            var end = "2019-1-30";
